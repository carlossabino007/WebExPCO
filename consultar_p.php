...
<html lang="en" class="no-js">
	...
	<body onLoad="setTimeout(window.close, 500000)">
		<header>
			<form action="conexion_oracle_consultar_p.php" method="POST" name="movistar" class="hero" onsubmit="return validar();">
										<?php
				...
				<div class="container">
					...
					<TABLE>
						<tr>
						<center><td>CEDULA:</td> <td><input type="text" name="cedula"></td>
						</tr>
						<tr>
						<td colspan="2"><center><br><input type="submit" value="Consultar"></td>
						</tr>
						</table>
					</center>
					<BR>
